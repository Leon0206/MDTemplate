...
#      move_business_file
    ...
    def image_category_h
      "Pod/Classes/UIImage+" + @pod_name + ".h"
   end

   def image_category_m
      "Pod/Classes/UIImage+" + @pod_name + ".m"
   end
...
#    end
    ...
    def set_prefix_name prefix_name
    ...
    def customise_prefix
      ...
      pch.gsub!("${INCLUDED_PREFIXES}", @prefixes)
